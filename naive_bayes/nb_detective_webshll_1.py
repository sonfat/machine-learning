...
if __name__ == "__main__":
    ...
    y1 = [1] * len(x1)
    vocabulary = webshell_bigram_verctorizer.vocabulary_
    # print vocabulary

    #wordpress
    wp_bigram_verctorizer = CountVectorizer(ngram_range=(2, 2), decode_error="ignore", token_pattern = r'\b\w+\b',min_df=1,vocabulary=vocabulary)
